...
class ab_DualGCN_Spatial_fist(nn.Module):
    def __init__(self, inchannels,f_channels=4,copy_wight=1,g_inchannels=4):
        ...
        n_resblocks = 0
        res_block_s1 = [
            ConvBlock(inchannels, 24, 3, 1, 1, activation='prelu', norm=None, bias = False,groups=4), #None
        ]
...
class Net(nn.Module):
    def __init__(self, num_channels, base_filter, args): #, base_filter, args
        ...
        self.head_0=ConvBlock(interplanes, interplanes, 1, 1, 0, activation='prelu', norm=None, bias = False)
        self.head2_0=ConvBlock(3, 3, 1, 1, 0, activation='prelu', norm=None, bias = False)
    ...
    def forward(self,l_ms,bms,pan):
        ...
        x=self.gcn_basic1(x1,bms,bms)#24   pan0
        x=self.gcn_basic2(x,bms,bms) #24
