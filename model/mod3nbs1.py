...
class Net(nn.Module):
    def __init__(self, num_channels, base_filter, args): #, base_filter, args
        ...
        self.BMM1=Bandmodulation(48,48)
        ...
        self.BMM3=Bandmodulation(24,24)
        self.bconv3=ConvBlock(24, 24, 1, 1, 0, activation='prelu', norm=None, bias = False)
        self.BMM4=Bandmodulation(24,24)
        self.bconv4=ConvBlock(24, 24, 1, 1, 0, activation='prelu', norm=None, bias = False)
