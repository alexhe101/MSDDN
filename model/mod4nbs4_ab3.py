...
class Bandmodulation(nn.Module):
    def __init__(self,in_channels, out_channels,f_channels=4,bias=True,split=4,copy_wight=3,g_inchannels=1):
        ...
        setattr(self, 'cgconv{}'.format(0),CGConv(in_channels=in_split, out_channels=out_split, g_inchannels=copy_wight * g_inchannels))
    def forward(self,input,f_input,g_input):
        ...
        for i in range(self.num_split):
            ...
            output.append(getattr(self,'cgconv{}'.format(0))(split_fusion,g_x))
