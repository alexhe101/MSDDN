...
class Net(nn.Module):
    def __init__(self, num_channels, base_filter, args): #
        ...
        self.gcn_basic1=Bandmodulation(24,24)
        self.gcn_basic2=Bandmodulation(24,24)
        self.gcn_basic3=Bandmodulation(24,24)
        self.gcn_basic4=Bandmodulation(24,24)
        self.gcn_basic5=Bandmodulation(24,24)
        self.gcn_basic6=Bandmodulation(24,24)
        self.gcn_basic7=Bandmodulation(24,24)
        self.gcn_basic8=Bandmodulation(24,24)
    ...
    def forward(self,l_ms,bms,pan):
        ...
        x0=self.head(bms) #128 c=16
        x1=self.conv1(x0)  #24
        x=self.gcn_basic1(x1,pan)#24
        x=self.gcn_basic2(x,pan) #24
        x=self.gcn_basic3(x,pan)
        x=self.gcn_basic4(x,pan)
        x=self.gcn_basic5(x,pan)
        x=self.gcn_basic6(x,pan)
        x=self.gcn_basic7(x,pan)
        x=self.gcn_basic8(x,pan)
