...
class Net(nn.Module):
    def __init__(self, num_channels, base_filter, args): #, base_filter, args
        ...
        self.conv1=ConvBlock(interplanes,num_channels , 3, 1, 1, activation='prelu', norm=None, bias = False)


        self.head2=ConvBlock(5, interplanes, 3, 1, 1, activation='prelu', norm=None, bias = False)
        self.gcn_basic2=fu_DualGCN_Spatial_fist(interplanes)
        self.upsam2=Upsampler(2, interplanes, activation='prelu')
        self.conv2=ConvBlock(interplanes, num_channels, 3, 1, 1, activation='prelu', norm=None, bias = False)

        self.head3=ConvBlock(5, interplanes, 3, 1, 1, activation='prelu', norm=None, bias = False)
        self.gcn_basic3=fu_DualGCN_Spatial_fist(interplanes)
        self.conv3=ConvBlock(interplanes,num_channels , 3, 1, 1, activation='prelu', norm=None, bias = False)
