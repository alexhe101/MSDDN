...
class Net(nn.Module):
    def __init__(self, num_channels, base_filter, args): #, base_filter, args
        ...
        self.head = ConvBlock(inchannel, interplanes, 9, 1, 4, activation='prelu', norm=None, bias = False)#914
        self.conv1=ConvBlock(16,24 , 3, 1, 1, activation='prelu', norm=None, bias = False)
        self.conv2=ConvBlock(48, 24, 3, 1, 1, activation='prelu', norm=None, bias = False)

       # self.conv3=ConvBlock(64,16 , 3, 1, 1, activation='prelu', norm=None, bias = False)
        #self.conv4=ConvBlock(24, 16, 3, 2, 1, activation='prelu', norm=None, bias = False)

        self.head2=ConvBlock(1, 3, 9, 1, 4, activation='prelu', norm=None, bias = False)#914
        #self.convpan1=ConvBlock(4, 4, 3, 2, 1, activation='prelu', norm=None, bias = False)
        #self.convpan2=ConvBlock(4, 4, 3, 2, 1, activation='prelu', norm=None, bias = False)

        #self.enhancer=Enhancer(26,24)
