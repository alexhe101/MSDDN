...
class ASPP(nn.Module):
    ...
    def forward(self, x):
        ...
        net = self.conv_1x1_output(torch.cat([atrous_block1, atrous_block2, #image_features, 
                                              atrous_block3, atrous_block6], dim=1))
        return net
